defmodule GroundPlane.ExecutionFencing.StaleArtifactGuardTest do
  use ExUnit.Case, async: true

  alias GroundPlane.ExecutionFencing.PromotionEpoch
  alias GroundPlane.ExecutionFencing.RouterArtifactFence
  alias GroundPlane.ExecutionFencing.StaleArtifactGuard
