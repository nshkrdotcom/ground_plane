    ...
    with :ok <- ensure_required_fields(attrs),
      ...
      {:ok,
       %__MODULE__{
         ...
         resource_family: optional_string(attrs, :resource_family),
         resource_account_ref: optional_string(attrs, :resource_account_ref),
         resource_instance_ref: optional_string(attrs, :resource_instance_ref),
